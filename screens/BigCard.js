            ...
            <View style={styles.cardWraper}>
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View>
                        ...
                        <Text style={{ fontSize: 24, color: '#307A50', fontFamily: 'Avenir-Black' }}>300 MAD<Text style={{ fontSize: 12, fontFamily: 'Avenir-Medium' }}>/jour</Text></Text>
                    </View>
                    <View>
                ...
                <View style={styles.featuresHolder}>
                    <View style={styles.featuresWraper}>
                        <View style={styles.features}>
                            <Image source={require('../../assets/location.png')} height="25" width="27" />

                        </View>
                        <Text style={styles.featuresTitle}>Fes</Text>
                    </View>
                    <View style={styles.featuresWraper}>
                        <View style={styles.features}>
